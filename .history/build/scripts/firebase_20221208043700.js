...
window.onload = function(){
  ...
  if(currentUser == null){
    ...
    userlink.classList.replace('nav-link','homebtn');
    userlink.classList.add('homebtn-pri');
    userlink.href = 'signin.html';

    signoutlink.innerText = 'Login';
    signoutlink.classList.replace('navlink','homebtn');
    ...
    userlink.classList.replace('homebtn','navlink');
    userlink.classList.add('homebtn-pri');
    userlink.href = '#';

    signoutlink.innerText = 'Log out';
    signoutlink.classList.replace('homebtn','navlink');
    signoutlink.classList.add('btn-success');
    signoutlink.href = 'javascript:Sig';
  }
}
