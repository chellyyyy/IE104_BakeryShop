...
.then((snapshot)=>{
    ...
    document.querySelectorAll('.button-2').forEach(e => {
      e.addEventListener('click' , ()=> {
          ...
          // change là số lượng của 1 món hàng thêm vào Sum
          //change 2 là tổng số lượng của các món hàng đã thêm vào giỏ
          //change 3 là tổng số hàng đang có + thêm số hàng mới thêm
          change3 = Number(change + change2)
