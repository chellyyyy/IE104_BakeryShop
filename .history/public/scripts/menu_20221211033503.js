...
.then((snapshot)=>{
          ...
          <div class="popup_content"><a class="close" href="#">&times;</a>
            <div class="product-all">
              ...
              <div class="product-2">
                ...
                <div class="Button">
                  <div class="button-1">
                    <button id="ut${e.ID}" class="is-form"">-</button>
                    <input class="input-qty" id="demoInput${e.ID}" aria-label="quantity" max="99" min="1" name="" type="number" value="1">
                    <button id ="plus"class="is-form">+</button>
                  </div>
    ...
    document.querySelectorAll('#minus').forEach(e => {
      e.addEventListener('click' , ()=> {
        minusID = 'demoInput' + e.id
        // document.getElementById(minusID).value = 2
        alert(minusID)
      })
    })
  })
