...
.then((snapshot)=>{
     //Data của user lấy từ database
    snapshot.forEach(childSnapshot => {
        userData.push(childSnapshot.val());
    });

    // userData.forEach((e)=>{
    //   document.getElementsByClassName('fullname').innerTEXT = e.fullname;
           
    // })
    document.getElementsByClassName('fullname').innerTEXT = userData.fullname;
})

console.log(userData.valu)
