...
.then((snapshot)=>{
    ...
    cakeData.forEach((e)=>{
      ...
      `
      <li class="completed">
        <p id='name_pro'>${e.NameOfCake}</p><button id = "Delbtn"><a href='#popup_del'>x</a></button>
      </li>
      `         
    })
})
...
function myFunction() {
    var x = document.getElementsByClassName('Yesbtn');
...
// document.getElementsByClassName('button-confirm').addEventListener('click', () => {
//     alert('111')
// });