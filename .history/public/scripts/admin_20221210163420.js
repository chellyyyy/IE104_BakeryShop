...
.then((snapshot)=>{
    ...
    cakeData.forEach((e)=>{
      ...
      `
      <li class="completed">
        <p id='name_pro${e.ID}'>${e.NameOfCake}</p><button id = "Delbtn"><a class='detect'>X</a></button>
      </li>
      `         
    })
...
// document.getElementsByClassName('detect').forEach(e => {
//     e.addEventListener('click' , ()=> {
//         alert(e.id)
//     }) 
// })
document.getElementsByClassName('detect').addEventListener('click', () => {
    al
})