      ...
      e.addEventListener('click' , ()=> {
          ...
          .then((snapshot)=>{
            ...
            if(cartBase == ''){
              ...
              set(ref(db, `UserList/${uid}/Bill/${cakeID}: ${change}`),{
                Name: cakeName,
                Amout: change,
                Price:price,
              })
              ...
              IDamout = cakeID + ': ' + proNumber
              update(ref(db, `UserList/${uid}/Bill/${IDamout}`),{
                Name: cakeName,
                Amout: proNumber,
                Price:price
              })
              // update(ref(db, `UserList/${uid}/Bill/Amout/${cakeID}: ${proNumber}`),{
              //   Name: cakeName
              // })
              Sum = Sum + proNumber
