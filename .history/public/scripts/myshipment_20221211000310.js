...
var Ufullname = document.getElementById('name_user').value;
...
function updateData(uid){
    ...
    if(Uaddress == ''){
        addChecked = document.getElementById('Userfullname').innerText;
    } else {
        addChecked = Uaddress
    }

    if(Up == ''){
        phoneChecked = document.getElementById('Userfullname').innerText;
    } else {
        nameChecked = Ufullname
    }
